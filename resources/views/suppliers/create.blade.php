                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control form-control-solid @error('company') is-invalid @enderror" id="company" name="company" type="text" placeholder="" value="{{ old('company') }}" />
                                @error('company')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="mb-3 col-md-6">
                                <label class="small mb-1" for="account">Account<span class="text-danger"></span></label>
                                <input class="form-control form-control-solid" id="account" name="account" type="text" placeholder="" value="{{ old('account') }}" />
                            </div>
                            <!-- Form Group (address) -->
                            <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control form-control-solid" id="state" name="state" type="text" placeholder="" value="{{ old('state') }}" />
                                
                            </div>
                            <div class="col-md-6">
                                <label class="small mb-1" for="zip">Zip<span class="text-danger"></span></label>
                                <input class="form-control form-control-solid" id="zip" name="zip" type="text" placeholder="" value="{{ old('zip') }}" />
                                
                            </div>
                            <div class="col-md-6">
                                <label class="small mb-1" for="country">Country<span class="text-danger"></span></label>
                                <input class="form-control form-control-solid" id="country" name="country" type="text" placeholder="" value="{{ old('country') }}" />
                                
                            </div>
                            <div class="mb-3">
                                <label for="comments">Comments <span class="text-danger"></span></label>
                                <textarea class="form-control form-control-solid" id="comments" name="comments" rows="3">{{ old('comments') }}</textarea>
                            </div>
                            <div class="mb-3">
                                <label for="notes">Internal notes <span class="text-danger"></span></label>
                                <textarea class="form-control form-control-solid" id="notes" name="notes" rows="3">{{ old('notes') }}</textarea>
                            </div>
                        </div>
                        <!-- Submit button -->
