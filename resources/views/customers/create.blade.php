            ...
            <div class="col-xl-8">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label class="small mb-1" for="account">Account number # <span class="text-danger"></span></label>
                            <input class="form-control form-control-solid" id="account" name="account" type="number" placeholder="" value="{{ old('account') }}" />
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control form-control-solid" id="zip" name="zip" type="number" placeholder="" value="{{ old('zip') }}" />
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid" id="company" name="company" type="text" placeholder="" value="{{ old('company') }}" />
                        </div>
                        <div class="mb-3">
