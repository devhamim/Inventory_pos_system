            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            <div class="mb-3 col-md-6">
                                <label class="small mb-1" for="color">Color <span class="text-danger"></span></label>
                                <input class="form-control form-control-solid @error('color') is-invalid @enderror" id="color" name="color" type="text" placeholder="" value="{{ old('color', $product->color) }}" autocomplete="off" />
                                @error('color')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="mb-3 col-md-6">
                                <label class="small mb-1" for="size">Size <span class="text-danger"></span></label>
                                <input class="form-control form-control-solid @error('size') is-invalid @enderror" id="size" name="size" type="text" placeholder="" value="{{ old('size', $product->size) }}" autocomplete="off" />
                                @error('size')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
