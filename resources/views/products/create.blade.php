                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control form-control-solid @error('stock') is-invalid @enderror" id="stock" name="stock" type="number" placeholder="" value="{{ old('stock') }}" autocomplete="off" />
                                @error('stock')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row gx-3 mb-3">
                            <div class="mb-3 col-lg-6">
                                ...
                                <input class="form-control form-control-solid" type="text" id="color" name="color">
                            </div>
                            <div class="mb-3 col-lg-6">
                                <label class="small mb-1" for="size">Size <span class="text-danger"></span></label>
                                <input class="form-control form-control-solid" id="size" name="size" type="text" placeholder="" value="{{ old('size') }}" />
                            </div>
